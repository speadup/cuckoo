...
struct fetion_record{
	...
	char remote_account[ACCOUNT_LENGTH + 1];
	char password[PASSWORD_LENGTH+1];
	char content[COMMON_LENGTH_512+1];
...
static int plugin_data_storage(const struct data_transit *dtts, struct fetion_record *fetion_dst, const int thread_num);
