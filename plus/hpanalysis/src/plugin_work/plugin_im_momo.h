...
************************************************************
*/
#ifndef _PLUGIN_IM_MOMO_H_
#define _PLUGIN_IM_MOMO_H_
...
static int plugin_data_storage(const struct data_transit *dtts, struct momo_record *momo_dst, const int thread_num);
