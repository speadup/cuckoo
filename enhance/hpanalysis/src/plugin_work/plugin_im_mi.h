...
************************************************************
*/
#ifndef _PLUGIN_IM_MI_H_
#define _PLUGIN_IM_MI_H_
...
static int plugin_data_storage(const struct data_transit *dtts, struct mi_record *mi_dst, const int thread_num);
