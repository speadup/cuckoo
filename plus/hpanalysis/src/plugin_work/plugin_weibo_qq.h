...
************************************************************
*/
#ifndef _PLUGIN_WEIBO_QQ_H_
#define _PLUGIN_WEIBO_QQ_H_
...
static int plugin_data_storage(const struct data_transit *dtts, struct qqwb_record *qqwb_dst, const int thread_num);
