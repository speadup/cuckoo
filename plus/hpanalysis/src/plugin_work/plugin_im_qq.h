...
************************************************************
*/
#ifndef _PLUGIN_IM_QQ_H_
#define _PLUGIN_IM_QQ_H_
...
static int plugin_data_storage(const struct data_transit *dtts, struct qq_record *qq_dst, const int thread_num);
