...
************************************************************
*/
#ifndef _PLUGIN_IM_BILIN_H_
#define _PLUGIN_IM_BILIN_H_
...
static int plugin_data_storage(const struct data_transit *dtts, struct bilin_record *bilin_dst, const int thread_num);
