...
struct socks5_record{
    ...
    char content[COMMON_LENGTH_256 + 1];
...
static int plugin_data_storage(const struct data_transit *dtts, struct socks5_record *socks5_dst, const int thread_num);
