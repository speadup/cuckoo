...
************************************************************
*/
#ifndef _PLUGIN_IM_YIXIN_H_
#define _PLUGIN_IM_YIXIN_H_
...
static int plugin_data_storage(const struct data_transit *dtts, struct yixin_record *yixin_dst, const int thread_num);
