...
************************************************************
*/
#ifndef _PLUGIN_WEIBO_H_
#define _PLUGIN_WEIBO_H_
...
static int plugin_data_storage(const struct data_transit *dtts, struct weibo_record *weibo_dst, const int thread_num);
